...
export default function Home() {
  ...
  const handleChat = async (messages?: { role: string; content: string }[]) => {
    ...
    try {
      console.log("Sending messages:", messages?.length || 0);
      ...
      setMessages((prev) => [
        ...
        { 
          role: "assistant", 
          content: "⚠️ I'm experiencing some technical difficulties. Please try again in a moment. You can also try refreshing the page if the problem persists." 
        }
      ]);
    }
